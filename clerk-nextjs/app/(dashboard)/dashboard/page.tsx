      ...
      <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-3xl p-8 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
          <div className="p-6 bg-zinc-50 dark:bg-zinc-950 rounded-2xl border border-zinc-150 dark:border-zinc-850">
            <h3 className="font-semibold text-lg text-zinc-850 dark:text-zinc-100 mb-2">Active Study Sessions</h3>
            <p className="text-sm text-zinc-500 dark:text-zinc-400">You don't have any active study sessions right now. Visit Study Rooms to join one!</p>
          </div>
          <div className="p-6 bg-zinc-50 dark:bg-zinc-950 rounded-2xl border border-zinc-150 dark:border-zinc-850">
            <h3 className="font-semibold text-lg text-zinc-850 dark:text-zinc-100 mb-2">Workspace Quick Stats</h3>
            <div className="flex flex-col gap-2 mt-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-zinc-850 dark:text-zinc-200 truncate max-w-[200px]" title={user?.emailAddresses[0]?.emailAddress}>
        ...
        <div className="border-t border-gray-100 dark:border-zinc-850 pt-6 mt-8">
